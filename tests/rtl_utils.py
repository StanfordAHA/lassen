...
from peak.rtl_utils import compile_magma
...
def compile_to_magma(cls):
    assert issubclass(cls, Peak)
    pe_magma = compile_magma(cls)
    return pe_magma
    ...
    #PE_magma = compile_magma(PE)
    #PE_wrap = wrap_with_disassembler(pe_magma, disassembler, width,
    #                                         HashableDict(layout),
    #                                         instr_magma_type)
