...
def test_and():
    ...
    res, res_p = pe(inst, Data(1), Data(3))
    assert res==1
    assert res_p==0
...
def test_inv():
    pe = gen_pe(BitVector.get_family())()
    inst = asm.sub()
    res, res_p = pe(inst, Data(0xffff),Data(1))
    assert res==0xfffe
    assert res_p==0
...
def test_neg():
    pe = gen_pe(BitVector.get_family())()
    inst = asm.neg()
    res, res_p = pe(inst, Data(0),Data(1))
    assert res==0xffff
    assert res_p==0
...
def test_mult0():
    ...
    inst = asm.umult0()
    res, res_p = pe(inst, Data(2),Data(3))
    assert res==6
    assert res_p==0
...
def test_mult1():
    ...
    inst = asm.umult1()
    res, res_p = pe(inst, Data(0x200),Data(3))
    assert res==6
    assert res_p==0


    inst = asm.smult1()
    res, res_p = pe(inst, Data(-512),Data(3))
    assert res==-6
    assert res_p==0
...
def test_mult2():
    ...
    inst = asm.umult2()
    res, res_p = pe(inst, Data(0x200),Data(0x300))
    assert res==6
    assert res_p==0


    inst = asm.smult2()
    res, res_p = pe(inst, Data(-2*256),Data(3*256))
    assert res==-6
    assert res_p==0
...
def test_fp_add():
    ...
    # b   = [0, -112, 1.0000010]
    # res = [0, -111, 1.1000010]
    res, res_p = pe(inst, Data(0x801),Data(0x782))
    assert res==0x842
    assert res_p==0
...
def test_fp_mult():
    ...
    # mant = mant(a) * mant(b)
    # exp = exp(a) + exp(b)
    res, res_p = pe(inst, Data(0x4080),Data(0x4001))
    assert res==0x4101
    assert res_p==0
...
def test_lsl():
    pe = gen_pe(BitVector.get_family())()
    inst = asm.lsl()
    res, res_p = pe(inst, Data(2),Data(1))
    assert res==4
    assert res_p==0
...
def test_sel():
    pe = gen_pe(BitVector.get_family())()
    inst = asm.sel()
    res, res_p = pe(inst, Data(1),Data(2),Bit(0))
    assert res==2
    assert res_p==0
...
def test_umin():
    pe = gen_pe(BitVector.get_family())()
    inst = asm.umin()
    res, res_p = pe(inst, Data(1),Data(2))
    assert res==1
    assert res_p==0
...
def test_eq():
    pe = gen_pe(BitVector.get_family())()
    inst = asm.eq()
    res, res_p = pe(inst,Data(1),Data(1))
    assert res_p==1
...
def test_get_mant():
    ...
    inst = asm.fgetmant()
    # execute PE instruction with the arguments as inputs -  call PE.__call__
    res, res_p = pe(inst, Data(0x7F8A), Data(0x0000))
    assert res==0xA
    assert res_p==0
...
def test_add_exp_imm():
    ...
    inst = asm.faddiexp()
    # execute PE instruction with the arguments as inputs -  call PE.__call__
    res, res_p = pe(inst, Data(0x7F8A), Data(0x0005))
...
def test_sub_exp():
    ...
    inst = asm.fsubexp()
    # execute PE instruction with the arguments as inputs -  call PE.__call__
    res, res_p = pe(inst, Data(0x7F8A), Data(0x4005))
    # 7F8A => Sign=0; Exp=0xFF; Mant=0x0A
...
def test_cnvt_exp_to_float():
    ...
    inst = asm.fcnvexp2f()
    # execute PE instruction with the arguments as inputs -  call PE.__call__
    res, res_p = pe(inst, Data(0x4005), Data(0x0000))
...
def test_get_float_int():
    ...
    inst = asm.fgetfint()
    # execute PE instruction with the arguments as inputs -  call PE.__call__
    res, res_p = pe(inst, Data(0x4020), Data(0x0000))
